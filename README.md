...
[![Deploy to GitHub Pages](https://github.com/SZZhang0619/coding-interview-university/actions/workflows/deploy.yml/badge.svg)](https://github.com/SZZhang0619/coding-interview-university/actions/workflows/deploy.yml)
[![Live Demo](https://img.shields.io/badge/Live-Demo-blue)](https://szzhang0619.github.io/coding-interview-university/)

## Web App (Angular 20)
- 即時勾選進度與視覺化統計的現代化網頁版
- Live Demo: https://szzhang0619.github.io/coding-interview-university/
- 前端說明: 參見 coding-interview-university-angular/README.md
...
這裡有[15種排序演算法](https://www.youtube.com/watch?v=kPRA0W1kECg)的影片，如果你想對排序演算法有更多的了解，看看[Additional Detail on Some Subjects](#某些主題的額外知識)裡的「排序」這個部分
